    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 2 }}>
        ...
        <Grid container rowSpacing={2} p={2}>
          ...
          <Grid item xs={10}><Typography gutterBottom component="div" color="app_grey.dark">sdfdsgfdghsdfgfg</Typography></Grid>
          ...
          <Grid item xs={8}><Typography gutterBottom component="div" color="app_grey.dark">Dummy text refers to the bits of content that are used to fill a website mock-up. This text helps web designers better envision how the website will look as a finished product. ... Dummy text is also known as filler text or placeholder text, and it has been used for a long time in the various fields of online publishing.</Typography></Grid>
        </Grid>
